...
func (_mock *MockValidator) Validate(request *dto.PasteRequest) error {
...
func (_c *MockValidator_Validate_Call) Run(run func(request *dto.PasteRequest)) *MockValidator_Validate_Call {
...
func (_c *MockValidator_Validate_Call) RunAndReturn(run func(request *dto.PasteRequest) error) *MockValidator_Validate_Call {
	_c.Call.Return(run)
	return _c
}
